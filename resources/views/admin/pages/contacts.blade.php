                        ...
                        <div class="col-md-12">
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i>Edit Site Info 
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="{{route('admin.contacts.update')}}" enctype="multipart/form-data" method="post" onsubmit="return false;">
                                        <div class="form-body">
                                            ...
                                            <div class="col-md-6" style="margin-bottom: 20px;">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Google URL :</label>
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon ">
                                                            <i class="fa fa-user"></i>
                                            ...
                                            <div class="col-md-8" style="margin-left: 170px; margin-bottom: 50px; margin-top: 20px;">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="map" class="form-control" value="{{$contact->map}}" placeholder="Map..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
