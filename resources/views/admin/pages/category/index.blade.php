                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.category.edit' , ['id' => $category->category_id]) }}" class="btn green"><i class="fa fa-edit"></i> Edit   </a>   <button class="btn btn-danger btndelet" data-url="{{ route('admin.category.delete' , ['id' => $category->category_id]) }}" >
