        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo" style="background-color: #26344b;">
                        <a href="{{route('admin.home')}}" style="color: #fff; margin-top: 17px; font-size: medium; margin-left: 17px; margin-bottom: 15px;"><img style="max-width: 120px;" src="{{asset('assets/admin/images/site.png')}}" alt="" />
                        </a> 
                                    ...
                                    <li>
                                        <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                            ...
                                            <li style="padding: 7px;">
                                                    ...
                                                    <span class="message" style="margin-right: 20px; margin-left: 0px; text-align: left;">
